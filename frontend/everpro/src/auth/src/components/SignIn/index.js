...
import {faGoogle,faFacebook,faTwitter,faYoutube,faInstagram} from "@fortawesome/free-brands-svg-icons";
  ...
  render() {
    ...
    return (
      <form onSubmit={this.onSubmit}>
        ...
        <button type="submit">Sign In with <FontAwesomeIcon icon={faGoogle} size="2x" /> </button>
...
class SignInFacebookBase extends Component {
  ...
  render() {
    ...
    return (
      <form onSubmit={this.onSubmit}>
        <button type="submit">Sign In with <FontAwesomeIcon icon={faFacebook} size="2x" /></button>
...
class SignInTwitterBase extends Component {
  ...
  render() {
    ...
    return (
      <form onSubmit={this.onSubmit}>
        <button type="submit">Sign In with  <FontAwesomeIcon icon={faTwitter} size="2x" /></button>
